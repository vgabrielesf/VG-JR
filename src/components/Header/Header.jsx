                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex-shrink-0">
                        <h1 className="text-2xl text-blue-600 dark:text-blue-400" style={{fontFamily: 'Poppins, sans-serif', fontWeight: 'normal'}}>
                            &lt;VG<span style={{background: 'linear-gradient(90deg, #f97316 0%, #3b82f6 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', color: 'transparent'}}>&amp;</span><span style={{color: '#f97316'}}>JR</span>&gt;
                        </h1>
                    </div>
